// wav.cpp — Minimal RIFF/WAVE reader & writer (mono).
//
// Verbatim port of pwilkin/openmoss (Apache-2.0) src/wav.cpp into the
// audiocore::io namespace. The upstream project deliberately avoids pulling
// in libsndfile / dr_wav so the shipped binary stays self-contained; the same
// applies to audiocore.
