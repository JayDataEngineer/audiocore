...
VENDOR_DIR="/home/user/Documents/programs/ray/vendor/moss-tts-v2"
export PYTHONPATH="$PROJECT_DIR:$VENDOR_DIR:$PYTHONPATH"

# Download the audio tokenizer ONNX if not already cached locally
HF_CACHE_ONNX="/home/user/.cache/huggingface/hub/models--OpenMOSS-Team--MOSS-Audio-Tokenizer-ONNX/snapshots/c7468e67a0ce987a6a76c4dfb3314e400cc335a2"
...
HF_CACHE_GGUF="/home/user/.cache/huggingface/hub/models--OpenMOSS-Team--MOSS-TTS-GGUF/snapshots/ede25f5ba2ad752292821ad51c4ee590f21373ff"
